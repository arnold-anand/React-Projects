...
export default class NewsItem extends Component {
  render() {
    let {title, description, date, url} = this.props;
    return (
        <div className='m-8'>
            <div className='w-80 border border-gray-200 border-opacity-60  rounded-xl'>
            <img class="lg:h-48 md:h-36 w-full object-cover object-center rounded-t-lg" src="https://dummyimage.com/720x400" alt="blog"/>
            <div className="p-6">
            ...
            <div class="flex items-center flex-wrap ">
              <a href={url} class="text-blue-500 inline-flex items-center md:mb-2 lg:mb-0">Learn More
